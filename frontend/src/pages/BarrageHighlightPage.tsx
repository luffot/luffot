...
export default function BarrageHighlightPage() {
  ...
  const updateRule = (index: number, field: keyof BarrageHighlightRule, value: string) => {
    if (!config) return
    const newRules = [...config.highlight_rules]
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900">弹幕特别关注设置</h1>
        <p className="text-gray-500 mt-1">配置特别关注规则，命中关键词的弹幕将以醒目颜色高亮显示</p>
      </div>
      ...
      <div className="card">
        <div className="card-header flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={addRule} className="btn-primary btn-sm">
